      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-8">
        <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
          <div className="space-y-6">
            <div className="card">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-text-soft">{job.company_name}</p>
              ...
              {job.skills?.length > 0 && (
                <div className="mt-5">
                  <h2 className="mb-2 text-sm font-semibold text-text">Skills required</h2>
            ...
            {job.description && (
              <div className="card">
                <h2 className="text-lg font-bold text-text">About this role</h2>
                <div className="prose prose-sm mt-3 max-w-none whitespace-pre-wrap text-text-soft">
                  {job.description}
                </div>
              </div>
            )}
            ...
            {job.interview_process && (
              <div className="card">
                <h2 className="text-lg font-bold text-text">Interview process</h2>
                <div className="prose prose-sm mt-3 max-w-none whitespace-pre-wrap text-text-soft">
                  {job.interview_process}
                </div>
              </div>
            ...
            <div className="card">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                <div className="rounded-card bg-white/[0.03] p-3">
                  ...
                  <p className="text-xs text-text-faint">Avg response</p>
                </div>
                <div className="rounded-card bg-white/[0.03] p-3">
          ...
          <aside className="space-y-4 lg:sticky lg:top-20 lg:self-start">
            ...
            <div className="rounded-card border border-border bg-bg-card p-4 text-xs text-text-soft">
              <p className="font-semibold text-text">Buyer protection</p>
            ...
            <Link
              href="/jobs"
              className="block text-center text-sm text-text-faint hover:text-primary"
            >
              ← Back to all jobs
            </Link>
          </aside>
